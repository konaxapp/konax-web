...
function DataRow({ label, value }) {
  return (
    <div style={styles.dataRow} className="vista-data-row">
      <span style={styles.dataLabel} className="vista-data-label">
        {label}
      </span>
      <strong style={styles.dataValue} className="vista-data-value">
        {value}
      </strong>
    </div>
  );
