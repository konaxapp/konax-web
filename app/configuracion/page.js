    ...
    <div style={pagina}>
      <div style={contenedor}>
        ...
        <div style={empresaCard}>
          ...
          <p style={texto}>
            Tipo de negocio: <strong>{empresa?.tipo_negocio || "No definido"}</strong>
          </p>
        </div>
        ...
        <div style={grid}>
          <Modulo
            ...
            icono="🏢"
            activo={true}
            onClick={() => abrirRuta("/configuracion/empresa")}
          />
          ...
          <Modulo
            ...
            onClick={() => abrirRuta("/configuracion/cobranza")}
          />
          ...
          <Modulo
            ...
            onClick={() => abrirRuta("/configuracion/caja")}
          />
          ...
          <Modulo
            ...
            icono="📄"
            activo={true}
            onClick={() => abrirRuta("/configuracion/documentos")}
          />
          ...
          <Modulo
            ...
            onClick={() => abrirRuta("/configuracion/inventario")}
          />
