...
export async function asignarPlanEmpresa(
  ...
  const modulosFinales =
    esNegocioBelleza(empresaActual)
      ? {
          ...plan.modulos,
          ...MODULOS_BELLEZA,
        }
    ...
    .insert([
      {
        ...
        descripcion:
          esNegocioBelleza(empresaActual)
            ? `Se asignó el plan ${plan.nombre} con configuración especial de Belleza.`
            : `Se asignó el plan ${plan.nombre} a la empresa.`,
        estado_anterior:
          empresaActual?.estado_plan ||
          null,
        estado_nuevo: "Activo",
        usuario: "KONAX",
      },
  ...
  return {
    ...
    mensaje:
      esNegocioBelleza(empresaActual)
        ? `Plan ${plan.nombre} asignado correctamente con módulos de Belleza.`
    ...
    .insert([
      {
        ...
        accion:
          "Pago registrado",
        descripcion: `Pago registrado por ${Number(
          monto
        ).toFixed(
          2
        )} vía ${
